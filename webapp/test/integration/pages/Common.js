sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("ac/TaskProcessing_Application/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#TaskProcessingApplication-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#TaskProcessingApplication-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("ac.TaskProcessing_Application.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ac/TaskProcessing_Application/localService/mockserver"], function (mockserver) {
