...
sap.ui.define([
		...
		"ac/TaskProcessing_Application/model/grouper",
		"ac/TaskProcessing_Application/model/GroupSortState"
		...
		return BaseController.extend("ac.TaskProcessing_Application.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("ac.TaskProcessing_Application.view.ViewSettingsDialog", this);
