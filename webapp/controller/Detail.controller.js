/*global location */
sap.ui.define([
	"ac/TaskProcessing_Application/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"ac/TaskProcessing_Application/model/formatter"
], function(BaseController, JSONModel, formatter) {
	"use strict";
	return BaseController.extend("ac.TaskProcessing_Application.controller.Detail", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		/* =========================================================== */
		/* Press Function for SelectDialog                        */
		/* =========================================================== */
		onCommentsPress: function(oEvent) {
			/*Instantiate and Component Style Class for the Fragment*/
			if (!this._oUserInfoDialog) {
				this._oUserInfoDialog = sap.ui.xmlfragment("ac.TaskProcessing_Application.view.UserInfoDialog", this);
		...
		/* =========================================================== */
		/* Search Bar Function for SelectDialog                        */
		/* =========================================================== */
		...
		/* =========================================================== */
		/* Close Function for SelectDialog                             */
		/* =========================================================== */
		handleClose: function(oEvent) {
			var aContexts = oEvent.getParameter("selectedContexts");
			//console.log(aContexts);
			if (aContexts.length) {
				sap.m.MessageToast.show("You have chosen " + aContexts.map(function(oContext) {
